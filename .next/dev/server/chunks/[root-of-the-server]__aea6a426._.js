...
"[project]/pages/api/emails/import.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const EmailItemSchema = __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].object({
    ...
    received_at: __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].string().refine((v)=>!Number.isNaN(Date.parse(v)), {
...
const ImportPayloadSchema = __TURBOPACK__imported__module__$5b$externals$5d2f$zod__$5b$external$5d$__$28$zod$2c$__esm_import$29$__["z"].array(EmailItemSchema).min(1);
...
async function handler(req, res) {
    ...
    try {
        ...
        for (const item of data){
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["prisma"].email.upsert({
                where: {
                    externalId_userId: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aea6a426._.js.map